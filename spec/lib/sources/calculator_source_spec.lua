...
describe("CalculatorSource", function()
  ...
  describe(".format_suffixed", function()
    it("truncates to a whole number below 1000", function()
      ...
      assert.are.equal("999", CalculatorSource.format_suffixed(999.99999))
      assert.are.equal("2", CalculatorSource.format_suffixed(2.9))
      assert.are.equal("0", CalculatorSource.format_suffixed(1 / 3))
    ...
    it("keeps the sign of a negative value", function()
      ...
      assert.are.equal("-23k", CalculatorSource.format_suffixed(-23456))
      assert.are.equal("-2", CalculatorSource.format_suffixed(-2.5))
    end)

    it("does not show a negative zero", function()
      assert.are.equal("0", CalculatorSource.format_suffixed(-0.5))
    end)
  end)
