...
describe("CalculatorSource", function()
  ...
  describe(".format_suffixed", function()
    ...
    it("shows one fixed decimal digit from 1000 up to 10000", function()
      ...
      assert.are.equal("4.3k", CalculatorSource.format_suffixed(4399))
    end)
    ...
    it("truncates instead of rounding, so a value never displays as more than it is", function()
      assert.are.equal("9.9k", CalculatorSource.format_suffixed(9999))
      assert.are.equal("999k", CalculatorSource.format_suffixed(999999))
      assert.are.equal("1.9M", CalculatorSource.format_suffixed(1999999))
      assert.are.equal("999.9M", CalculatorSource.format_suffixed(999999999))
      assert.are.equal("999.9B", CalculatorSource.format_suffixed(999999999999))
    end)
    ...
    it("uses M, B and T with one decimal digit", function()
      ...
      assert.are.equal("123.4M", CalculatorSource.format_suffixed(123456789))
