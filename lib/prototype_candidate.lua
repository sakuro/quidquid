...
local function build_candidates(candidate_type, icon_prefix, query, prototype_list, locale, translation_cache, include_hidden)
  local candidates = {}
    ...
    if include_hidden or not prototype.hidden then
      ...
      if matched then
        table.insert(candidates, {
          type = candidate_type, id = prototype.name, label = prototype.localised_name,
